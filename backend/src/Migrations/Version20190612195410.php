 ...
 */
final class Version20190612195410 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE master_product (id INT NOT NULL, name VARCHAR(255) NOT NULL, unit enum_unit_type NOT NULL, quantity NUMERIC(10, 2) NOT NULL, amount INT NOT NULL, image VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
